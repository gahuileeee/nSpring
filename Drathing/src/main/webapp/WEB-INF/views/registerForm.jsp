...
<body>
    ...
    <div class="login-container">
       <c:url var="actionUrl" value="/login/login01" />
		<form class="login-form" id="form" action="${actionUrl}" onsubmit="return onSubmitForm()" method="post">
	...
	<c:url var="loginUrl" value="/login/login01" />
